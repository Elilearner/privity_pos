      ...
      await database
          ...
          .insertOnConflictUpdate(
            db.SalesCompanion.insert(
              ...
              customerPhone: drift.Value(sale.customerPhone),
              deliveryAddress: drift.Value(sale.deliveryAddress),
              deliveryReference: drift.Value(sale.deliveryReference),
    ...
    for (final saleRow in saleRows) {
      ...
      result.add(
        domain_sale.Sale(
          ...
          deliveryAddress: saleRow.deliveryAddress,
          deliveryReference: saleRow.deliveryReference,
